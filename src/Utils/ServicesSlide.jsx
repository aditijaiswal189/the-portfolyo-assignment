  ...
  return (
    <div className="flex p-8 items-center rounded-3xl ">
      ...
      <div>
        ...
        <button className=" font-extrabold text-3xl p-3 text-blue-500 border-solid border-[1px] border-blue-400 px-5 rounded-xl hover:bg-blue-400 hover:text-stone-100 tracking-wider active:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 ">
          {servicesData.charge}
        </button>
      </div>
    </div>
